...
pub const MattermostChannel = struct {
    ...
    pub fn sendTypingIndicator(self: *MattermostChannel, target: []const u8) void {
        ...
        const resp = root.http_util.httpPost(self.allocator, url, body, &headers) catch return;
    ...
    fn sendPost(self: *MattermostChannel, channel_id: []const u8, text: []const u8, thread_id: ?[]const u8) !void {
        ...
        const resp = root.http_util.httpPost(self.allocator, url, body, &headers) catch return error.MattermostApiError;
